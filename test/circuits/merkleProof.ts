...
describe("Merkle Proof Circuit Component", () => {
    ...
    const expectedRoot = "9091466005283815162448404040090924144531762766638646206839479435316552583073";
    ...
    it("output changes on having a different leaf", async () => {
        ...
        forgedInput.leaf += 1;
        const witness = await circuit.calculateLabeledWitness(forgedInput, sanityCheck);
